...
\begin{equation*}
    \pi(\text{stay}|A) = \theta_1, ~~ \pi(\text{stay}|A) = \theta_2, ~~ \theta_1, \theta_2 \in [0,1], ~~ \mathbf{\boldsymbol\theta} = (\theta_1, \theta_2),
\end{equation*}
...
\begin{equation*}
    ...
    \end{split}
\end{equation*}
We can test the concavity by checking whether each value function has negative-semidefinite Hessian.
\end{document}